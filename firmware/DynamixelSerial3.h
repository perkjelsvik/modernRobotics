...
#define TIME_OUT                    250        // Este parametro depende de la velocidad de transmision
#define TX_DELAY_TIME				50       // Este parametro depende de la velocidad de transmision - pero pueden ser cambiados para mayor velocidad.
#define Tx_MODE                     1
#define Rx_MODE                     0
#define LOCK                        1
